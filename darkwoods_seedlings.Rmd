...
pacman::p_load(
  ...
  pandoc,
  rgdal, rpanel,
  spatstat, spatstat.data, spatstat.local
  )
...
set.seed(123)
pacman::p_load(openxls)
darkwoods_seedlings_data <- openxlsx::read.xlsx("1.1.darkwoods_seedlings.xlsx")
...
```{r, warning=FALSE, message=FALSE}
darkwoods_seedlings_tree_distance = openxlsx::read.xlsx("~/repos/darkwoods-seedlings/1.2.darkwoods_seedlings_distance.xlsx")
darkwoods_seedlings_tree_distance
#knitr::kable(head(darkwoods_seedlings_tree_distance))

elevation_utm = readAll(raster("./SpatialData/elevation_utm.tif"))
aspect_utm = readAll(raster("./SpatialData/aspect_utm.tif"))
slope_utm = readAll(raster("./SpatialData/slope_utm.tif"))
rix_utm = readAll(raster("./SpatialData/rix_utm.tif"))
twi_utm = readAll(raster("./SpatialData/twi_utm.tif"))
wind_utm = readAll(raster("./SpatialData/wind_utm.tif"))
mpb_grey_utm = readAll(raster("./SpatialData/mpb_grey_na.tif"))
mpb_red_utm = readAll(raster("./SpatialData/mpb_red_na.tif"))
fire_high_utm = readAll(raster("./SpatialData/fire_high_na.tif"))
fire_med_utm = readAll(raster("./SpatialData/fire_med_na.tif"))
fire_low_utm = readAll(raster("./SpatialData/fire_low_na.tif"))
```
